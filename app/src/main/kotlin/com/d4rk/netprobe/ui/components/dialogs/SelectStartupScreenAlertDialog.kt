package com.d4rk.netprobe.ui.components.dialogs
...
fun SelectStartupScreenAlertDialog(
    ...
    val defaultPage : MutableState<String> = remember { mutableStateOf(BottomBarRoutes.SPEED_TEST) }
...
fun SelectStartupScreenAlertDialogContent(
    ...
    LaunchedEffect(Unit) {
        selectedPage.value = dataStore.getStartupPage().firstOrNull() ?: BottomBarRoutes.SPEED_TEST
    }
