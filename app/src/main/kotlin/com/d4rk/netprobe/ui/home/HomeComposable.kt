...
fun HomeComposable(
    ...
    ConstraintLayout(
        ...
        Column(modifier = Modifier
            ...
            Text(
                text = context.getString(R.string.your_ip, state.value.ipAddress),
                modifier = Modifier
                    .padding(top = 4.dp)
                    .clickable {
            ...
            state.value.scanResult?.let { scanResult ->
                ...
                AnimatedText(
                    text = context.getString(
                        ...
                        scanResult.serverCount.toString()
                    ),
                    modifier = Modifier.padding(top = 4.dp)
                )
            }
        ...
        Column(modifier = Modifier
            ...
            ExtendedFloatingActionButton(
                onClick = { /* TODO: Implement speed test action */ },
                modifier = Modifier
                    .wrapContentSize()
                    .bounceClick(),
                text = { Text(context.getString(R.string.speed_test)) },
                icon = {
                    Icon(
                        imageVector = Icons.Filled.Speed,
                        contentDescription = context.getString(R.string.content_description_speed_test)
                    )
                }
            )
        }
...
fun AnimatedText(
    ...
    characterDurationMillis: Int = 50
) {
